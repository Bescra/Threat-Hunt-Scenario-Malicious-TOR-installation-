...
DeviceFileEvents
| where FileName contains "THIS.txt"
```

---

## Created By:
- **Author Name**: Rubem Tavares
- **Author Contact**: https://www.linkedin.com/in/rubem-tavares-77900a258/
- **Date**: March 12, 2026
...
|-------------|-------------------------------|------------------|-------------------|
| 1.0         | Initial draft                  | `March  12, 2026`  | `Rubem Tavares`   
